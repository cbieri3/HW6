...
Partial Class _default
    ...
    Protected Sub sendMail_Click(sender As Object, e As EventArgs) Handles sendMail.Click
        ...
        sendersEmail = sEmail.Text.ToString() 'capture the senders email from the textbox
        sendersMessage = sMail.Text.ToString().Replace(Environment.NewLine, "<br />")   ' get the text from the message textbox keep text box formatting by replacing new lines (returns) with <br/>


        msg.To.Add("casebieri@yahoo.com")  'destination email address
